    ...
    <v-card width="300" class=" pa-3" height="530">
      ...
      <v-card-actions class="justify-center">
        ...
        class="mt-5"
          ...
          :size="150"
          :width="20"
          :value= persentaseMengajar.persentaseMengajarDosen
          color="#59DCDC"
      ...
      <v-row>
        ...
        <v-col>
          <v-card-text class="mt-1 mr-2 text-right">{{persentaseMengajar.persentaseMengajarDosen}}</v-card-text>
        </v-col>
      </v-row>
      <v-row
      class="mt-0 pt-0">
        ...
        <v-col cols="4">
          <v-card-text class="mt-1 mr-2 ml-0 text-right">{{100 - persentaseMengajar.persentaseMengajarDosen}}</v-card-text>
        </v-col>
      </v-row>
    </v-card>
  </v-flex>
