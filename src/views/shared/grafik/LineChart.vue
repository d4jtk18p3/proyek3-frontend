    ...
    <v-row>
      <v-col cols="12">
        <div class="d-flex justify-center">
          <div class="text-h6 font-weight-bold ml-3 flex-grow-0 d-flex  align-center" :style="{color: currentTheme.onSurface}">{{ this.chartTitle }}</div>
          <div class="flex-grow-1 d-flex justify-end align-center"><slot  name="top-right"></slot></div>
        </div>
      </v-col>
      <v-col cols="12">
        <apexchart type="line" :height="this.height" :width="this.width"  :options="data.chartOptions" :series="data.series"/>
      </v-col>
    </v-row>
