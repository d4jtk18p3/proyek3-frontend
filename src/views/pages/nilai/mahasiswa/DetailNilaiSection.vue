...
<script>
import DetailNilaiDekstop from "@/views/pages/nilai/mahasiswa/DetailNilaiDekstop"
import DetailNilaiMobile from "@/views/pages/nilai/mahasiswa/DetailNilaiMobile"
export default {
